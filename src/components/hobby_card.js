        ...
        <div className="p-2">
            <div className={`portfoliocard`}>
                <section className="portfolioimg">
                    <Image src={hobby.cover} fluid height={"100%"} />
                </section>
                <section className="portfoliodetail">
                    <div className="portfoliotag  flex-wrap d-flex">
                        <span className="portfoliotagbox">{hobby.category}</span>
                    </div>
                    <div className="portfoliotitle">
                        {hobby.name}
                    </div>
                    <div className="portfoliodescription">
                        {hobby.content.replace(/(<([^>]+)>)/ig, " ")}
                    </div>
                    <div style={{ marginTop: 20 }}>
                        <a className="portfoliobtn" href={`/hobby/${hobby.slug}/detail`} aria-label={`Click to open ${hobby.name}`}>
                        ...
                        <span class="screen-reader-text">{hobby.name}</span>
                    </div>
