        ...
        <div className="p-2 h-100">
            <div className={`portfoliocard h-100 ${className}`}>
                ...
                <section className="portfoliodetail">
                    <div className="portfoliotag  flex-wrap">
                        {
                    ...
                    <div style={{ marginTop: 20, bottom: 0 }}>
                        <a className="portfoliobtn" href={`/project/${project.slug}/detail`} aria-label={`Click to open ${project.name}`}>
                            ...
                            <span class="screen-reader-text">{project.name}</span>
                        </a>
                    </div>
