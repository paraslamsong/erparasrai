...
export default function PortfolioCard({ className }) {
            ...
            <div className={`portfoliocard ${className}`}>
                ...
                <section className="portfoliodetail">
                    <div className="portfoliotag  flex-wrap d-flex">
                        {
                            ["Flutter", "Django", "React", "Flutter", "Django", "React", "Flutter", "Django", "React"].map((t) => tag(t))
                        }
                    </div>
                    ...
                    <div style={{ marginTop: 20 }}>
                        <span className="portfoliobtn" onClick={() => navigate("/project/hello-world/detail")}>
